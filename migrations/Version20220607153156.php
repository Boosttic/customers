 ...
 */
final class Version20220607153156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, port_id INT NOT NULL, server_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, dns VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_A45BDDC176E92A9C (port_id), INDEX IDX_A45BDDC11844E6B7 (server_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE server (id INT AUTO_INCREMENT NOT NULL, ram_id INT DEFAULT NULL, stockage_id INT DEFAULT NULL, d_b_id INT DEFAULT NULL, ip VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, provider VARCHAR(255) NOT NULL, server TINYINT(1) NOT NULL, proc VARCHAR(255) DEFAULT NULL, debit VARCHAR(255) DEFAULT NULL, INDEX IDX_5A6DD5F63366068 (ram_id), INDEX IDX_5A6DD5F6DAA83D7F (stockage_id), UNIQUE INDEX UNIQ_5A6DD5F690CB975F (d_b_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE application ADD CONSTRAINT FK_A45BDDC11844E6B7 FOREIGN KEY (server_id) REFERENCES server (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application DROP FOREIGN KEY FK_A45BDDC11844E6B7');
